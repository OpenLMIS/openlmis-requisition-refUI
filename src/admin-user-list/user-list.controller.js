...
(function() {
	...
	controller.$inject = ['$state', '$stateParams', 'users', 'confirmService', 'paginationService'];

	function controller($state, $stateParams, users, confirmService, paginationService) {
